...
- **Authentication & Authorization** — JWT (access + refresh), OTP via email
...
- Implement real-world authentication flows (OTP + JWT
...
- **Event-driven** — Kafka decouples booking, payment, inventory, search and notification flows. 
...
- **Authentication**: JWT (access + refresh), OTP via SendGrid
...
User registration, OTP verification, JWT issuance + rotation, profile management.
...
REDIS_URL=redis://:your_pass@localhost:6379
...
DATABASE_URL=postgres://your_name:your_pass@localhost:5432/user_service_database
REDIS_URL=redis://:your_pass@localhost:6379
...
DATABASE_URL=postgres://your_name:your_pass@localhost:5432/admin_service_database
...
DATABASE_URL=postgres://your_name:your_pass@localhost:5432/booking_service_database
REDIS_URL=redis://:your_pass@localhost:6379
...
DATABASE_URL=postgres://ayour_name:your_pass@localhost:5432/payment_service_database
ALLOWED_ORIGINS=http://localhost:3000,http://localhost:4000
...
DATABASE_URL=postgres://your_name:your_passs@localhost:5432/inventory_service_database
ALLOWED_ORIGINS=http://localhost:3000,http://localhost:4000
